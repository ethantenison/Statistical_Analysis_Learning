...
mod.tree <- tree(duct_system_1_leakage ~ system_1_location_air_handler + system_1_age_years + furnace_fuel_type + home_type + system_1_sqft_ton +  conditioned_sqft, data = train, mindev = 0.001, minsize = 10 )
